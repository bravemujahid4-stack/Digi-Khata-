...
private val DarkColorScheme = darkColorScheme(
    primary = VibrantNavyPrimary,
    onPrimary = Color.White,
    primaryContainer = VibrantNavyContainer,
    onPrimaryContainer = VibrantNavyDark,
...
private val LightColorScheme = lightColorScheme(
    primary = VibrantNavyDark,
    onPrimary = Color.White,
    primaryContainer = VibrantNavyContainer,
    onPrimaryContainer = VibrantNavyDark,
    secondary = VibrantNavyPrimary,
    onSecondary = Color.White,
    secondaryContainer = VibrantNavyContainer,
    onSecondaryContainer = VibrantNavyDark,
